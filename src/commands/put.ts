...
export const command = "put <src> [dest] [address]";
export const describe = "Copy a file to a device";
...
export const builder: CopyCommand = {
    ...
    dest: {
        description: "the remote destination for the file"
    },
    src: {
        description: "the local file to copy"
    }
};
...
export function handler(args: CopyCommand) {
    const put = (device: Device): Promise<void> => {
        ...
        return ssh.put(args.src, args.dest);
    };
